...
const PRODUCTS = [
  {
    id: 1,
    name: "Pull en Maille Organique",
    brand: "Loom & Soft",
    price: "125",
    category: "Vêtements",
    image: getImageUrl(IMAGE_IDS.clothes),
  },
  {
    id: 2,
    name: "Sac Cabas en Lin Lavé",
    brand: "Studio Minimal",
    price: "85",
    category: "Accessoires",
    image: getImageUrl(IMAGE_IDS.shop),
  },
  {
    id: 3,
    name: "Sandales en Cuir Naturel",
    brand: "Pas à Pas",
    price: "140",
    category: "Chaussures",
    image: getImageUrl(IMAGE_IDS.entrance),
  },
  {
    id: 4,
    name: "Veste de Travail en Coton",
    brand: "Héritage Beige",
    price: "165",
    category: "Vêtements",
    image: getImageUrl(IMAGE_IDS.atelier),
  },
  {
    id: 5,
    name: "Écharpe en Cachemire Beige",
    brand: "Douceur Pure",
    price: "95",
    category: "Accessoires",
    image: getImageUrl(IMAGE_IDS.lastEvent),
  },
  {
    id: 6,
    name: "Derbies en Daim Souple",
    brand: "Pas à Pas",
    price: "190",
    category: "Chaussures",
    image: getImageUrl(IMAGE_IDS.coffeeMenu),
  },
];
